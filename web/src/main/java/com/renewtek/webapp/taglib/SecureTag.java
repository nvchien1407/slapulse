...
public class SecureTag extends BodyTagSupport {
   ...
   private final Logger log = LoggerFactory.getLogger(SecureTag.class);
   ...
   public int doStartTag() throws JspException {
      ...
      Map<String, Object> config = (HashMap<String, Object>) pageContext.getServletContext().getAttribute(
            Constants.CONFIG);
