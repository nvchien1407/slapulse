...
public class LoginServletTest extends TestCase {
   ...
   public void testInit() throws Exception {
      ...
      Map appConfig = (HashMap) servlet.getServletContext().getAttribute(Constants.CONFIG);
      assertEquals(appConfig.get(Constants.HTTP_PORT), "80");
      assertEquals(appConfig.get(Constants.HTTPS_PORT), "443");
      assertEquals(appConfig.get(Constants.SECURE_LOGIN), Boolean.valueOf("true"));
